...
#define IS_PIN_DIGITAL(p)       (((p) >= 2 && (p) <= 19) && !((p) >= 10 && (p) <= 13) && !((p)==6 || (p)==7 || (p)==4))
#define IS_PIN_ANALOG(p)        ((p) >= 14 && (p) < 14 + TOTAL_ANALOG_PINS)
#define IS_PIN_PWM(p)           (digitalPinHasPWM(p) && !((p) >= 10 && (p) <= 12) && !((p)==6 || (p)==7 || (p)==4))
#define IS_PIN_SERVO(p)         (((p) >= 2 && (p) <= 13 ) && !((p) >= 10 && (p) <= 13) && !((p)==6 || (p)==7 || (p)==4))
...
#define VERSION_BLINK_PIN       13
#define IS_PIN_DIGITAL(p)       (((p) >= 2 && (p) <= 19) && !((p)==6 || (p)==7 || (p)==4))
#define IS_PIN_ANALOG(p)        ((p) >= 14 && (p) < 14 + TOTAL_ANALOG_PINS)
#define IS_PIN_PWM(p)           (digitalPinHasPWM(p) && !((p)==6 || (p)==7 || (p)==4))
#define IS_PIN_SERVO(p)         (((p) >= 2 && (p) <= 13 ) && !((p)==6 || (p)==7 || (p)==4))
#define IS_PIN_I2C(p)           ((p) == 18 || (p) == 19)
#define PIN_TO_DIGITAL(p)       (p)
#define PIN_TO_ANALOG(p)        ((p) - 14)
#define PIN_TO_PWM(p)           PIN_TO_DIGITAL(p)
...
// Teensy 1.0
#elif defined(__AVR_AT90USB162__) && defined(CORE_TEENSY)
...
// Teensy++ 1.0 and 2.0
#elif (defined(__AVR_AT90USB646__) || defined(__AVR_AT90USB1286__)) && defined(CORE_TEENSY)
#define TOTAL_ANALOG_PINS       8
